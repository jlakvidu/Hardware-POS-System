...
const showConfirmPassword = ref(false); // Added missing ref
...
const circles = ref([
  {
    ...
    directionY: 1,
    gradient:
      "linear-gradient(135deg, rgba(37, 99, 235, 0.7), rgba(79, 70, 229, 0.7))",
  ...
  },
  {
    ...
    directionY: 1,
    gradient:
      "linear-gradient(135deg, rgba(14, 165, 233, 0.6), rgba(79, 70, 229, 0.6))",
  ...
  },
  {
    ...
    directionY: -1,
    gradient:
      "linear-gradient(135deg, rgba(236, 72, 153, 0.5), rgba(217, 70, 239, 0.5))",
  ...
  },
  {
    ...
    directionY: 1,
    gradient:
      "linear-gradient(135deg, rgba(16, 185, 129, 0.5), rgba(6, 182, 212, 0.5))",
  ...
  },
  {
    ...
    directionY: -1,
    gradient:
      "linear-gradient(135deg, rgba(20, 184, 166, 0.5), rgba(56, 189, 248, 0.5))",
...
const startAnimation = () => {
  const animate = () => {
    ...
    circles.value.forEach((circle) => {
      ...
      if (Math.random() < 0.005) circle.directionX *= -1;
      if (Math.random() < 0.005) circle.directionY *= -1;
      if (Math.random() < 0.01) {
      ...
      if (circle.x > 95) circle.directionX = -1;
      else if (circle.x < 5) circle.directionX = 1;

      if (circle.y > 90) circle.directionY = -1;
      else if (circle.y < 10) circle.directionY = 1;
    });
...
<template>
  ...
  >
    <div class="grid lg:grid-cols-2 w-full h-screen">
      <div
        class="hidden lg:flex flex-col justify-between p-12 relative overflow-hidden h-screen"
        style="background-color: #050a24"
      >
        ...
        <div
          class="absolute inset-0 bg-gradient-to-br from-blue-600/20 to-transparent"
        ></div>
      </div>

      <div
        class="flex items-center justify-center w-full px-8 relative overflow-hidden"
      >
        ...
        <div
          class="absolute top-0 right-0 w-96 h-96 bg-blue-600/10 rounded-full blur-3xl transform translate-x-1/2 -translate-y-1/2"
        ></div>
        <div
          class="absolute bottom-0 right-1/4 w-80 h-80 bg-indigo-600/10 rounded-full blur-3xl"
        ></div>

        <div
          class="w-full max-w-md rounded-2xl overflow-hidden relative z-10"
        ...
        >
          <div class="p-8">
            ...
            <form @submit.prevent="handleSignUp" class="space-y-6">
              <div
                v-if="error"
                class="p-4 bg-red-500/10 border border-red-500/20 rounded-lg text-red-500"
              >
                {{ error }}
              </div>
              ...
              <div>
                ...
                />
                <div
                  v-if="credentials.name && credentials.name.length < 3"
              ...
              <div>
                ...
                <input
                  ...
                  @input="validateForm"
                  class="w-full px-4 py-3 rounded-lg bg-gray-800 border border-gray-700 text-white focus:outline-none"
                  :class="credentials.email && /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(credentials.email)
                            ? 'focus:border-blue-500'
                            : 'focus:border-red-500'"
                ...
                />
                <div
                  v-if="credentials.email && !/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(credentials.email)"
                  class="text-red-500 text-sm mt-1"
                >
              ...
              <div>
                ...
                <div class="relative">
                  <input
                    ...
                    class="w-full px-4 py-3 pr-12 rounded-lg bg-gray-800 border border-gray-700 text-white focus:outline-none"
                    :class="credentials.password && /^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[A-Za-z\d]{8,}$/.test(credentials.password)
                              ? 'focus:border-blue-500'
                              : 'focus:border-red-500'"
                ...
                <div
                  v-if="credentials.password && !/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[A-Za-z\d]{8,}$/.test(credentials.password)"
                  class="text-red-500 text-sm mt-1"
                >
                  Password must include both uppercase and lowercase letters and at least one number.
                </div>
              </div>
              ...
              <div>
                ...
                <div class="relative">
                  <input
                    ...
                    required
                    @input="validatePasswords"
                    class="w-full px-4 py-3 pr-12 rounded-lg bg-gray-800 border text-white focus:outline-none"
                    :class="[
                ...
                <div
                  v-if="!passwordsMatch && credentials.confirmPassword"
                  class="text-red-500 text-sm mt-1"
                >
