    ...
    <div class="w-full p-4 lg:p-8 pt-28 lg:pt-28">
      ...
      >
        <div>
          ...
          <p class="text-gray-400 text-sm">Last login: {{ lastLogin }}</p>
        </div>
      </div>
      ...
      <div class="flex gap-6">
        ...
        >
          <div class="flex justify-between items-center mb-6">
            ...
            <button
              class="text-sm text-blue-400 hover:text-blue-300 transition-colors duration-200 flex items-center gap-1"
              @click="refreshRecentTransactions"
              :disabled="isLoading"
              title="Refresh Transactions"
            >
              <svg v-if="isLoading" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 animate-spin" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
              </svg>
              <svg v-else xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  d="M4 4v5h.582M20 20v-5h-.581M5.635 19A9 9 0 1119 5.635M19 19l-3-3m0 0l3-3" />
              </svg>
              Refresh
            </button>
          </div>
