...
import Sidebar from './Sidebar-cashier.vue'
import { 
    MagnifyingGlassIcon, 
    UserPlusIcon, 
    PencilIcon, 
...
const openEditModal = (customer) => {
    editingCustomer.value = {
        ...customer,
        contact: Array.isArray(customer.contact) && customer.contact.length > 0
            ? customer.contact
            : [{ contact_number: '' }]
    }
...
<template>
    <div class="bg-gray-900 min-h-screen text-white w-full h-full">
